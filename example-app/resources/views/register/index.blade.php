...
<div class="naikin-margin row justify-content-center align-items-center vh-100">
  <div class="col-md-5">  
    <main class="form-registration w-100 m-auto">
      <h1 class="h3 mb-3 fw-normal text-center fw-semibold text-primary ">Registration Form</h1>
      ...
      <small class="d-block text-center">Already registered ? <a href="/login">Login</a>
      </small>
    </main>
  </div>
</div>
